package eu.smpmc.soul.zopnote.api.components;
...
public class ComplexItem implements Cloneable {
  ...
  public ComplexItem generateKey() {
    ItemMeta meta = this.ITEM.getItemMeta();
    meta.getPersistentDataContainer().set(new NamespacedKey(Soul.getInstance(), identification), PersistentDataType.DOUBLE, Math.PI);
    this.ITEM.setItemMeta(meta);
    return this;
  }
  public static NamespacedKey createKey(String identification) {
    return new NamespacedKey(Soul.getInstance(), identification);
  }
